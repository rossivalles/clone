...
CREATE TABLE `post` (
  ...
  `idItem` int NOT NULL,
  `Categoria` enum('electrodomesticos','ropa','libros','tecnologia','colleccionismo','') NOT NULL,
...
INSERT INTO items(idUs,Nombre,Descripcion,Image)
VALUES(1,"Libro de Harry Potter","Libro de harry potter donde aparece la serpiente","img/libro_harry_potter.png");


INSERT INTO items(idUs,Nombre,Descripcion,Image)
VALUES(2,"Portatil Gaming","Portatil gaming con rtx 3070 16GB RAM 1TB HHD","img/portatil.png");
